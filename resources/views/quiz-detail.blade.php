                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <textarea disabled class="form-control" rows="3" name="question">{{$quiz->question}}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Option 1</label>
                            <input disabled type="text" class="form-control" name="option_0" value="{{ isset($options[0]->value) ? $options[0]->value : null }}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Option 2</label>
                            <input disabled type="text" class="form-control" name="option_1" value="{{ isset($options[1]->value) ? $options[1]->value : null }}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Option 3</label>
                            <input disabled type="text" class="form-control" name="option_2" value="{{ isset($options[2]->value) ? $options[2]->value : null }}">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Option 4</label>
                            <input disabled type="text" class="form-control" name="option_3" value="{{ isset($options[3]->value) ? $options[3]->value : null }}">
                        </div>
                        <div class="form-group">
                            <label>Correct Option</label>
                            <select disabled class="custom-select col-12" id="inlineFormCustomSelect" name="correct_option">
                    ...
                    <table id="playerQuizAnswerTable" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>                                
                                ...
                                <td>{{$playerQuizAnswer->player_activity->player->name ?: 'Name Not Found'}}</td>   
