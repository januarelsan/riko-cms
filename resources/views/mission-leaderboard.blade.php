...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Finish Mission</a></li>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Finish Mission Leaderboard</h4>
                    ...
                    <table id="leaderboardTable" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>Highest Finished Mission</th>    
                                <th>Actions</th>                                
                            </tr>
                        </thead>
                        ...
                        <tbody>
                            @foreach ($players as $player)                                
                                <tr>
                                    ...
                                    <td>{{$player->email}}</td>     
                                    @if($player->player_activities->sum('player_finish_mission.player_activity.activity.id') > 0)                               
                                        <td>{{$player->player_activities->max('player_finish_mission.player_activity.activity.id') - 2}}</td>                          
                                    @else
                                        <td>0</td>                          
                                    @endif
                                    <td>
